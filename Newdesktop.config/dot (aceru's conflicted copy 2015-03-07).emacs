...
(setq org-todo-keyword-faces '(("TODO" . (:foreground "white")) 
							   ("INPROGRESS" . (:foregroud "yellow" )) 
...
(add-to-list 'load-path "~/.emacs.d/elpa/auto-complete-20150225.715")
...
;; W to view html in w3m
;; (defun harrison-dired-w3m-visit ()
;;   (interactive)
...
(add-hook 'dired-mode-hook
          (function (lambda()
                      ...
                      ;;(define-key dired-mode-map "W" 'harrison-dired-w3m-visit)
                      )
                    )
)
...
;;;The user part of a tramp file name can be omitted.
;;;(setq tramp-default-user "harrisont")
